  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        <Link to="/tools" className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground mb-8 transition-colors">
        ...
        <section className="mb-8 animate-fade-in">
          ...
          <div className="bg-card border border-border rounded-2xl p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              <Pill icon={Tv} label="IFE" on={!!data.ife_type && data.ife_type !== "None"} onText={data.ife_type.replace(/_/g, " ")} offText="None" />
              <Pill icon={Wifi} label="Connectivity" on={!!data.connectivity_type && data.connectivity_type !== "None"} onText={data.connectivity_type} offText="None" />
