    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-28 text-center max-w-3xl mx-auto px-6 overflow-hidden">
        ...
        <div className="relative">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl mx-auto mb-6">
            AI-scored intelligence across the global commercial fleet to identify lease and acquisition opportunities.
          </p>

          <p className="text-base md:text-[17px] text-foreground/75 font-medium max-w-2xl mx-auto mb-10 leading-snug">
            Identify high-probability acquisition and lease opportunities in seconds.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-6">
            ...
            <button
              onClick={() => navigate("/aircraft/c027d251-7fc3-4a0e-84d9-43642bb8e7e6")}
      ...
      <section className="py-28 border-t border-border bg-card/50 relative">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <p className="text-sm text-muted-foreground/80 italic text-center max-w-2xl mx-auto mb-10 leading-relaxed">
            This isn't raw data — it's a structured representation of each aircraft's economic and operational profile.
          </p>
