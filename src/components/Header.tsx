      ...
      <div className="max-w-5xl mx-auto flex items-center justify-between h-12 px-6">
        <div className="flex items-center gap-6">
          <Link to="/" className="flex items-center gap-2 group">
            <Plane className="h-4 w-4 text-foreground transition-transform group-hover:-rotate-12" />
            <span className="font-semibold text-sm tracking-tight text-foreground">AeroScout</span>
          </Link>
          <nav className="flex items-center gap-4">
            ...
            <Link
              ...
              className={cn(
                "text-sm transition-colors",
                location.pathname === "/quick-lookup" ? "text-foreground font-medium" : "text-muted-foreground hover:text-foreground"
              )}
            >
              Quick Lookup
            </Link>
            <Link
              ...
              className={cn(
                "text-sm transition-colors",
                location.pathname === "/directory" ? "text-foreground font-medium" : "text-muted-foreground hover:text-foreground"
              )}
            >
              Directory
            </Link>
