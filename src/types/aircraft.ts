...
export interface FrontendAircraft {
  aircraft: {
    ...
    total_seats: number;
    seat_pitch_economy_inches: number;
    seat_manufacturer?: string | null;
    ife_type?: string | null;
    ife_manufacturer?: string | null;
  ...
  operator: {
    ...
    aircraft_id?: string;
    operator_name: string;
    operator_iata_code?: string | null;
    operator_icao_code?: string | null;
    operator_country?: string | null;
    operator_type: string;
    alliance_membership?: string | null;
    lease_type?: string | null;
    lease_start_date?: string | null;
    lease_end_date: string;
    monthly_lease_rate_usd: number;
    maintenance_reserve_rate_usd?: number | null;
    security_deposit_usd?: number | null;
    operator_credit_rating?: string | null;
    operator_financial_health_score: number;
    operator_in_distress: boolean;
    is_current_operator: boolean;
    primary_base_iata?: string | null;
    route_type?: string | null;
    avg_daily_flight_hours?: number | null;
    avg_daily_flight_cycles?: number | null;
