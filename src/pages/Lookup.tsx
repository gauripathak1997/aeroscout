        ...
        <section className="pb-24">
          <div className="rounded-xl border border-border bg-card/40 px-6 py-5 flex items-center justify-between gap-6">
            ...
            <button
              ...
              className="flex-shrink-0 inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-border bg-background text-foreground text-xs font-medium hover:border-primary/40 hover:bg-muted/50 transition-all"
            >
              Request Access
